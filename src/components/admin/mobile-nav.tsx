...
export function MobileNav({ displayName, children }: MobileNavProps) {
    ...
    return (
        <header 
            className="bg-white border-b border-slate-200 sticky top-0 z-10 md:hidden w-full"
        ...
        >
            <div className="h-16 px-6 flex items-center justify-between w-full">
                <div className="flex flex-col justify-center">
                    ...
                    <p className="text-[10px] leading-none text-slate-500 mt-0.5 font-medium">{displayName}님</p>
                </div>

                <Sheet open={open} onOpenChange={setOpen}>
                    <SheetTrigger asChild>
                        <Button id="btn-mobile-menu" variant="ghost" size="icon">
