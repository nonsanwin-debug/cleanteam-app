...
import { LayoutDashboard, Users, Building2, Settings, ArchiveRestore, Megaphone, MessageSquarePlus, Wallet, Gift, Share2, Trash2, EyeOff, FileDown } from 'lucide-react'
import { cn } from '@/lib/utils'
import { Badge } from '@/components/ui/badge'

const NAV_ITEMS = [
    { href: '/master/dashboard', icon: LayoutDashboard, label: '대시보드', iconColor: 'text-blue-500' },
    { href: '/master/customer-inquiries', icon: MessageSquarePlus, label: '고객 문의 관리', iconColor: 'text-rose-500' },
    { href: '/master/orders', icon: Share2, label: '파트너 오더 관리', iconColor: 'text-indigo-500' },
    { href: '/master/blog-package', icon: FileDown, label: 'AI 블로그 패키지', iconColor: 'text-indigo-600' },
    { href: '/master/deleted-orders', icon: Trash2, label: '삭제 오더 관리', iconColor: 'text-red-500' },
    ...
    { href: '/master/partner-rewards', icon: Gift, label: '파트너 리워드', iconColor: 'text-amber-500' },
    { href: '/master/cash-requests', icon: Wallet, label: '캐쉬 충전 관리', iconColor: 'text-cyan-500' },
    { href: '/master/point-exchanges', icon: Gift, label: '포인트 교환 관리', iconColor: 'text-orange-500', showBadge: true },
    ...
    { href: '/master/launch-control', icon: EyeOff, label: '런칭 기능 제어', iconColor: 'text-rose-400' },
