...
export function CustomerBookClient({ partnerId, rewardType, freeOldBuilding = false, freeInterior = false }: { partnerId: string, rewardType: 'discount' | 'points', freeOldBuilding?: boolean, freeInterior?: boolean }) {
