            ...
            <CardContent className="px-6 pb-8">
              <div className="space-y-4 mb-6">
                <Button 
                  ...
                  className="w-full text-[15px] py-6 bg-[#FEE500] text-[#000000] hover:bg-[#FEE500]/90 font-bold border border-[#FEE500]/20 rounded-xl" 
                  disabled={isLoading}
                >
                  {isLoading ? (
              ...
              <div className="relative mb-6">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-white px-2 text-slate-400 font-medium tracking-tight">또는 기존 계정 사용</span>
                </div>
              </div>
              ...
              <form onSubmit={handleAuth} className="space-y-3">
                ...
                <Button type="submit" className="w-full text-[15px] py-5 bg-slate-800 hover:bg-slate-900 text-white rounded-xl mt-2 border border-slate-700" disabled={isLoading}>
                  {isLoading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : (isSignUp ? '기존 계정으로 등록' : '기존 계정 로그인')}
                </Button>
              </form>
