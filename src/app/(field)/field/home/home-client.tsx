                                ...
                                >
                                    <CardContent className="p-4 space-y-3">
                                        ...
                                        <div className="flex items-center gap-2 flex-wrap">
                                            {site.company_name && (
                                                <div className="flex items-center gap-1 bg-slate-100 px-2.5 py-1 rounded-md text-xs font-semibold text-slate-700">
                                                    <Building2 className="w-3 h-3 text-teal-600" />
                                                    {site.company_name}
                                                </div>
                                            )}
                                            {site.worker_name && (
                                                <div className="flex items-center gap-1 bg-slate-100 px-2.5 py-1 rounded-md text-xs font-semibold text-slate-600">
