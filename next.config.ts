...
const nextConfig: NextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_KAKAO_REST_KEY: process.env.NEXT_PUBLIC_KAKAO_REST_KEY || '81419459fd9a7438b545e265f699d054',
    NEXT_PUBLIC_KAKAO_SHARE_KEY: process.env.NEXT_PUBLIC_KAKAO_SHARE_KEY || 'b35cc64bd8157efcda468c80b5956eff',
  },
  images: {
    remotePatterns: [
      {
